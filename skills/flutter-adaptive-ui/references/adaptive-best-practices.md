...
Another example is the web's low barrier for sharing. If you're deploying a web app, decide which deep links to support, and design your navigation routes with those in mind.

Think about what each platform does best and whether there are unique capabilities you can use.
